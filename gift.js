...
function main() {
    ...
    while ((nome_cliente.toUpperCase() != "DONO") && (cliente_atual != clientes_totais)) {  
        ...
        mostrar_texto(`Olá ${nome_cliente}, você fez ${compras_mensais} compras. Veja o seu cashback mensal!`)
        ...
        while(atual <= quantidade_compras) {
            ...
            compras_totais_clientes = compras_mensais
        }
    ...
    mostrar_texto(`Os clientes receberam R$ ${cashback_total_clientes} de cashback, representando ${((cashback_total_clientes * 100) / valor_compras_totais_loja).toFixed(2)}% do faturamento`) 
}
